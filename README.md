...
## V1 Features <a id="v1-features"></a>
...
* ​[Join liquidity pools](frontend-integration/pool-liquidity.md#add-liquidity) to collect fees on ETH-ERC20 pairs
...
* Trade [ETH for any ERC20](frontend-integration/trade-tokens.md#eth-erc20-trades) without wrapping
* Trade any [ERC20 for any ERC20](frontend-integration/trade-tokens.md#erc20-to-erc20) in a single transaction
...
![](.gitbook/assets/uniswap-how-it-works.png)

**ERC20 to ERC20 trades in Uniswap**
...
### List of interfaces \(updated November 2, 2018\) <a id="list-of-interfaces-updated-november-2-2018"></a>
